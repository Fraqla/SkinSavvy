<div class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-purple-200 to-pink-400 p-4">
    <div class="w-full max-w-md">
        ...
        <!-- Form Container -->
        <form wire:submit.prevent="register" class="w-full bg-white p-8 rounded-xl shadow-lg border border-white/20 backdrop-blur-sm">
            <!-- Name Field -->
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="password_confirmation" class="block text-sm font-medium text-rose-500 mb-2">Confirm Password</label>
                <input 
                    type="password" 
            ...
            <p class="mt-6 text-center text-sm text-rose-500">
                ...
                <a href="{{ route('sign-in') }}" class="font-medium text-rose-800 hover:text-indigo-800 hover:underline ml-1">Sign In</a>
            </p>
        </form>
    </div>
</div>