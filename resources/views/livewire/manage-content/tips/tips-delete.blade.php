    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all duration-300">
        ...
        <div class="bg-gradient-to-r from-red-50 to-pink-50 px-6 py-4 border-b border-red-100">
            <div class="flex items-center justify-between">
                ...
                <button wire:click="hideDeleteForm" class="text-gray-400 hover:text-gray-500">
        ...
        <div class="p-6">
            <div class="flex items-start">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900">Delete this tips?</h3>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
            <button wire:click="hideDeleteForm" class="px-4 py-2 bg-gray-300 rounded-md hover:bg-gray-400">
                Cancel
            </button>
