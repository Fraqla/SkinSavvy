        ...
        <div class="p-6 space-y-6">
            <form wire:submit.prevent="store">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" wire:model="detected_poison" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-200 focus:border-red-400 transition duration-200 shadow-sm hover:shadow"
                            placeholder="Enter detected poison">
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea wire:model="effect" rows="4" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-200 focus:border-red-400 transition duration-200 shadow-sm hover:shadow"
                            placeholder="Describe the effects"></textarea>
                        @error('effect')
                    ...
                    <div class="mt-4">
                        @if($tempImage)
                            <div class="relative group">
                                <img src="{{ $tempImage }}"
                                    class="h-40 w-full object-cover rounded-lg shadow-sm border border-gray-200">
                                <div
                                    ...
                                    <span class="text-white text-xs font-medium">New Image Preview</span>
                                </div>
                            </div>
                        @endif
                    </div>
