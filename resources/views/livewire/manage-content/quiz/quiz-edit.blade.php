<div
    class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto transition-opacity duration-300">
    <div
        class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 ease-out my-8 border border-gray-100">
        <!-- Modal Header -->
        <div
            class="sticky top-0 bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-5 border-b border-gray-200/60 z-10">
            <div class="flex items-center justify-between">
                ...
                <button wire:click="hideForms"
                    class="p-1.5 rounded-full hover:bg-gray-100 transition duration-150 text-gray-500 hover:text-gray-700">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-3">
                            ...
                            <div class="w-24">
                                <input type="number" wire:model="newAnswerScore"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl" placeholder="Score" />
                            </div>
                        ...
                        <div class="mt-4 space-y-3">
                            @foreach($answers as $index => $answer)
                                <div class="flex items-center space-x-3 group">
                                    <span
                                        class="flex-1 px-4 py-2.5 bg-gray-50 rounded-lg border border-gray-200 group-hover:bg-white group-hover:border-purple-200 transition duration-200">{{ $answer['text'] }}
                                        (Score: {{ $answer['score'] }})</span>
