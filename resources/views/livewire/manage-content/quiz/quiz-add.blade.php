        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    ...
                    <div class="flex-1 relative">
                        <input type="number" wire:model="newAnswerScore" min="0" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition duration-200 shadow-sm"
                            placeholder="Enter points for this answer">
                        @error('newAnswerScore')
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                ...
                <div class="mt-4 space-y-3">
                    @foreach($answers as $index => $answer)
                        <div class="flex items-center space-x-3 group">
                            <span class="flex-1 px-4 py-2.5 bg-gray-50 rounded-lg border border-gray-200 group-hover:bg-white group-hover:border-blue-200 transition duration-200">
                                {{ $answer['text'] }} - {{ $answer['score'] }} points
                            </span>
