    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all duration-300">
        ...
        <div class="p-6">
            <div class="flex items-start">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900">Delete this skin quiz?</h3>
                    <div class="mt-2 text-sm text-gray-500">
                        <p>Are you sure you want to delete <span class="font-medium">"{{ $skinTypeToDelete ?? 'this skin quiz' }}"</span>? This action cannot be undone.</p>
                    </div>
                </div>
            </div>
        </div>
