                            ...
                            @forelse($ingredients as $ingredient)
                                <tr wire:key="ingredient-{{ $ingredient->id }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @else
                                            <div
                                                class="h-16 w-16 bg-gray-100 rounded-lg flex items-center justify-center border border-gray-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">{{ $ingredient->ingredient_name }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-500 max-w-xs truncate">{{ $ingredient->function }}
                                        </div>
                                    </td>
