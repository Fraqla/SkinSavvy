        ...
        <div class="sticky top-0 bg-gradient-to-r from-pink-50 to-purple-50 px-6 py-4 border-b border-gray-200 z-10">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Edit Ingredient</h2>
                </div>
        ...
        <div class="p-6 space-y-6">
            <form wire:submit.prevent="store" enctype="multipart/form-data">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mt-4">
                                <div class="relative group">
                                    ...
                                    <div class="absolute inset-0 bg-black/20 rounded-lg opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center">
                                        <span class="text-white font-medium">{{ $image ? 'New Image Preview' : 'Current Image' }}</span>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            <textarea wire:model="function" rows="4" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-400 transition duration-200 shadow-sm hover:shadow"
                                placeholder="Describe the ingredient's function"></textarea>
                            @error('function')
                    ...
                    <!-- Facts -->
                    <div class="col-span-2 md:col-span-1">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Facts (Optional)</label>
                        <textarea wire:model="facts" rows="4"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-400 transition duration-200 shadow-sm hover:shadow"
                            placeholder="Add interesting facts"></textarea>
                    </div>

                    <!-- Benefits -->
                    <div class="col-span-2 md:col-span-1">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Benefits (Optional)</label>
                        <textarea wire:model="benefits" rows="4"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-400 transition duration-200 shadow-sm hover:shadow"
                            placeholder="List skin benefits"></textarea>
                    </div>
                </div>
