    ...
    <div
        ...
        <div class="sticky top-0 bg-gradient-to-r from-pink-50 to-purple-50 px-6 py-4 border-b border-gray-200 z-10">
            <div class="flex items-center justify-between">
                ...
                <button wire:click="$dispatch('hide-edit-promotion')"
                ...
                <div>
                    ...
                    @if($image)
                        <div class="mb-4 relative group">
                            ...
                            @elseif(method_exists($image, 'temporaryUrl'))
                                <!-- Newly selected temporary image -->
                                <img src="{{ $image->temporaryUrl() }}" class="w-full h-48 object-cover rounded-lg shadow-md">
                                <div
                                    class="absolute inset-0 bg-black/20 rounded-lg opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center">
                                    <span class="text-white font-medium">New Image Selected</span>
                                </div>
                            @endif
                        </div>
                    @endif
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label
                            class="flex flex-col w-full h-32 border-2 border-dashed border-gray-300 hover:border-gray-400 rounded-lg cursor-pointer transition duration-200 hover:bg-gray-50 relative overflow-hidden">
