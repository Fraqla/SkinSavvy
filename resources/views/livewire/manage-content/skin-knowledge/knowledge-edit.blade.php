        ...
        <form wire:submit.prevent="store" enctype="multipart/form-data" class="p-6 space-y-6">
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    @if ($tempImage)
                        <div class="mb-3">
                            <img src="{{ $tempImage }}" alt="Current Image"
                                class="rounded-md shadow max-w-xs h-auto mx-auto" />
                        </div>
                    @endif


                    <input type="file" wire:model="image" accept="image/*"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-400 transition duration-100" />
                ...
                <div>
                    ...
                    <textarea wire:model="description" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-400 transition duration-200"
                        placeholder="Enter detailed description about this skin type"></textarea>
