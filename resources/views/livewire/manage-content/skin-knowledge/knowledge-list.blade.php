                            ...
                            @forelse($skinKnowledges as $skinKnowledge)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="relative h-16 w-16 rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-gray-900">{{ $skinKnowledge->skin_type }}</div>
                                        <div class="text-xs text-gray-500 mt-1">Last updated {{ $skinKnowledge->updated_at->diffForHumans() }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center justify-center text-gray-400">
                                            ...
                                            <button wire:click="showAddForm" class="mt-4 px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg shadow hover:from-pink-600 hover:to-purple-700 transition duration-300">
                                                Create First Entry
                                            </button>
                                        </div>
                                    </td>
