        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-800 flex items-center">
                    ...
                    Pending Admin Consultant Approvals
                </h2>
                <p class="text-gray-600 mt-2">Review and approve new admin consultant applications</p>
            </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">Pending since {{ $user->created_at->diffForHumans() }}</div>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center">
                                        ...
                                        <p class="mt-1 text-gray-500">All admin consultant applications have been processed.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    document.addEventListener('livewire:load', function () {
        window.livewire.on('confirmRemove', userId => {
            Swal.fire({
                ...
                text: "Are you sure you want to remove this admin consultant?",
                icon: 'warning',
